...
| [docs/storage-v1-ddl-model.md](docs/storage-v1-ddl-model.md) | **storage/v1 table model** — the 45 tables and 30 views declared in the checked-in SQLite/PostgreSQL DDL, how the layers relate, and their declared keys |

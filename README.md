...
| [docs/storage-v1-ddl-model.md](docs/storage-v1-ddl-model.md) | **storage/v1 table model** — the tables and views declared in the checked-in SQLite/PostgreSQL DDL, how the layers relate, and their declared keys |
